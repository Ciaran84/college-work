/*
 ============================================================================
 Name        : 15725581_Assignment4_Q1_CiaranConlon.c
 ...
 was to learn how to handle arrays of linked lists. As such, all code for the linked lists was 
 written by me, as were the file read/write functions.
  ============================================================================
 */
...
{
    FILE *fp;
    fp = fopen("output1.txt","a+"); //append fil with splits data for 100m splits
